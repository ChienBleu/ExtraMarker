...
Here we see the expression of genes for each sample show no strong differences, the normalisation step should only slightly change our data.
...
x <- as.vector(all.data[,maxvar.g1])
y <- as.vector(all.data[,maxvar.g2])
plot(x,y, , pch = 19, col = colors, xlab=paste('gene', maxvar.g1), ylab=paste('gene', maxvar.g2))
```
